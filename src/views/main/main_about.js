...
function main_about() {
 ...
 let morelinks=switchTextReact("h5",LJS_get("view_main/mylinks0"),LJS_get("view_main/mylinks1"));
 let links=[] 
 let dataLinks=LJS_get("view_main/mylinks");
 let markdown=switchMarkdown("view_main/textAbout0.md","view_main/textAbout1.md");
  let linksContainer=React.createElement("div",{style:{textAlign:"center"}},links);
 ...
 for (let i=0;i<dataLinks.length;i++){
  ...
  let row=React.createElement("div",{className:"row align-items-center"},
    React.createElement("div",{className:"col-sm-12 col-md-8 col-lg-9"},titleAbout,br,markdown),
    ...
    return (
	  ...
	  br,
	  br,
	  React.createElement("div",{style:{textAlign:"center"}},morelinks),
	  linksContainer,
        )
    );
}
